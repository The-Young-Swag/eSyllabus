...
<div class="modal fade" id="menueditmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- <div class="form-group">
        <label>Status (0 = Active, 1 = Unactive)</label>
        <input type="text" class="form-control" id="edit_status"
               value="<?php echo htmlspecialchars($menu['UnActive']); ?>">
    </div> -->
	<!--
	<div class="form-group">
    <label>Status</label>
    <div class="custom-control custom-switch">
        <input type="checkbox"
               ...
               id="edit_status"
               <?php echo $menu['UnActive'] == 0 ? 'checked' : ''; ?>>
        <label class="custom-control-label" for="edit_status">
            <?php echo $menu['UnActive'] == 0 ? 'Active' : 'Inactive'; ?>
        </label>
    </div>
</div>
