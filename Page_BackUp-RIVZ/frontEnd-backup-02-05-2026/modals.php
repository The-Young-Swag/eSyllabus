    ...
    $employees = execsqlES("
        SELECT [EmpId], 
               CONCAT(UPPER([LastName]), ', ', [FirstName], ' ', 
                      IIF([MiddleInitial] IS NOT NULL, UPPER([MiddleInitial]), UPPER(LEFT([MiddleName], 1))), '.') AS EmpName
        FROM [tbl_Employees] 
            ...
            <div class="modal-content">
                ...
                <div class="p-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="edit_empID">
                            <option value="">-- Select Employee --</option>
                            <?php foreach ($employees as $emp): ?>
                                <option value="<?php echo $emp['EmpId']; ?>" 
                                    <?php echo ($emp['EmpId'] == $user['EmpID']) ? 'selected' : ''; ?>>
