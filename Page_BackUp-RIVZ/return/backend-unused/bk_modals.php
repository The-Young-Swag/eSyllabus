...
function generateMenuEditModal() {
    ...
    if ($menID > 0) {
        ...
        if (!empty($result) && is_array($result)) {
            $menuData = array_merge($menuData, $result[0]);
        } else {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="p-3">
                    ...
                    <input type="hidden" id="edit_menID" value="<?php echo $menu['MenID'] ?? ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="edit_status">
                            <option value="0" <?php echo ($menu['UnActive'] ?? 0) == 0 ? 'selected' : ''; ?>>Active</option>
                            <option value="1" <?php echo ($menu['UnActive'] ?? 0) == 1 ? 'selected' : ''; ?>>Inactive</option>
                        </select>
                    </div>
