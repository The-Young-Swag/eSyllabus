            ...
            <div class="modal-body px-4 pt-3 pb-2">
                ...
                <label class="d-flex align-items-center gap-3 px-3 py-2 rounded-2 border mb-1"
                    ...
                    <input type="checkbox" class="form-check-input m-0 flex-shrink-0"
                           id="exportCheckAll" style="width:16px;height:16px;">
                    <span class="small fw-semibold text-dark">All Sections</span>
                </label>
                ...
                <!-- Format tiles — equal width, vertically stacked icon + label -->
