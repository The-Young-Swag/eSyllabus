              ...
              <div class="row">
                ...
                <div class="col-md-6">
				  ...
				  <div class="form-group" hidden>
                    ...
                    <input type="text" class="form-control" id="doc_type" name="doc_type" value="Memorandum" >
                  </div>
				  ...
				  <div class="form-group">
                    <label for="doc_number">Memo Number</label>
                    <input type="text" class="form-control" id="doc_number" name="doc_number" placeholder="Memo Number..." required>
                  </div>
