      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4><b>Disbursement Voucher</b></h4>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <!-- User Form Start -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
				  ...
				  <div class="form-group" hidden>
                    ...
                    <input type="text" class="form-control" id="doc_type" name="doc_type" value="Disbursement Voucher" >
                  </div>
				  ...
				  <div class="form-group">
                    <label for="doc_number">DV Number</label>
