...
<div class="heading">
	<h1 class="pl-3 pt-2">Start a Process | Purchase Request</h1>
</div>
        ...
        <div class="card">
          <div class="card-header p-2">
            <ul class="nav nav-pills">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#prtable" data-toggle="tab">All PR Transactions</a>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
				  ...
				  <div class="form-group" hidden>
                    ...
                    <input type="text" class="form-control" id="doc_type" name="doc_type" value="Purchase Request" >
                  </div>
				  ...
				  <div class="form-group">
                    <label for="doc_number">PR Number</label>
                    <input type="text" class="form-control" id="doc_number" name="doc_number" placeholder="PR Number..." required>
                  </div>
            ...
            <!-- User Form Start -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
				  ...
				  <div class="form-group">
                    <label for="number">PR Number</label>
...
<div id="result_selected" class="mt-3"></div>	
          ...
          <!-- /.card-body -->
               ...
               <!-- PR Table -->
			   <div class="tab-pane" id="prtable">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Purchase Request List</h3><br>
					
				<div class="dropdown mt-1">
					<label for="destination">Data Limit:</label>
						<select class="form-select" aria-label="Default select example" id="pagilimit" 
						data-tableid="#tblviewpr" data-tableurl="backend/bk_transactionstable.php" data-tablereq="viewpr">
								<?php
									$pagi = execsqlSRS("
...
<script>
  ...
  TableLoader2.load2({
    ...
    request: { request:"viewpr", user_id: UserInfo["UserID"], user_name: UserInfo["Name"], user_office: UserInfo["Office_id"], pagi_limit:50 },
  });
